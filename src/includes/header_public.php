...
// Pastikan $pageTitle sudah di-set sebelum include file ini

declare(strict_types=1);

if (!isset($pageTitle)) $pageTitle = 'Toko Rini';
...
<header class="site-header">
    <div class="container header-inner">
        ...
        <nav class="main-nav">
            ...
            <a href="<?= e(waUrl('Halo Toko Rini, saya ingin bertanya tentang produk')) ?>"
